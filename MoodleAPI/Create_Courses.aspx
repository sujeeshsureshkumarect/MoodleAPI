<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create_Courses.aspx.cs" Inherits="MoodleAPI.Create_Courses"  MasterPageFile="~/Site.Master"%>
...
<table>
  <tr>
    ...
    <td><asp:TextBox ID="txt_fullname" runat="server" Text="Test Accounting Theory & Applications I"></asp:TextBox></td>   
  </tr>
    
  <tr>
    <td><asp:Label ID="lbl_shortname" runat="server" Text="Course Short Name"></asp:Label></td>
    <td><asp:TextBox ID="txt_shortname" runat="server" Text="TESTACC100_201937"></asp:TextBox></td>  
  </tr>
...
<td><asp:Label ID="lbl_idnumber" runat="server" Text="ID Number"></asp:Label></td>
    <td><asp:TextBox ID="txt_Idnumber" runat="server" Text="TESTACC100_201947"></asp:TextBox></td>  
  </tr>

     <tr>
<td><asp:Label ID="lbl_summary" runat="server" Text="Summary"></asp:Label></td>
    <td><asp:TextBox ID="txt_Summary" runat="server" TextMode="MultiLine" Height="160px" Text="Test Accounting Theory & Applications I"></asp:TextBox></td>  
  </tr>
