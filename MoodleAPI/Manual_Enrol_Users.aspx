...
<table>
  ...
  <tr>
    ...
    <td><asp:TextBox ID="txt_Courseid" runat="server"></asp:TextBox></td>  
     ...
     <tr>
    <td><asp:Label ID="lbl_Suspend" runat="server" Text="Suspend"></asp:Label></td>
    <td><asp:TextBox ID="txt_Suspend" runat="server" Text="0"></asp:TextBox></td>  
  </tr>
  <tr>
        <td><asp:Button ID="btn_Enroll" runat="server" Text="Enrol Users" OnClick="btn_Enroll_Click"/></td>
